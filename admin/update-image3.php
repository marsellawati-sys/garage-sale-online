                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" name="updateimg3" method="post" enctype="multipart/form-data">
<?php 
...
?>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Gambar 3 Saat Ini</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Pilih Gambar Baru (Image 3)</label>
                                        <div class="controls">
